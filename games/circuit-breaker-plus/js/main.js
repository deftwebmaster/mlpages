...
const elements = {
  ...
  menuAdStatus: $("menu-ad-status"),
  menuPurchaseButton: $("menu-purchase-button"),
  pauseOverlay: $("pause-overlay"),
  helpOverlay: $("help-overlay"),
  adOverlay: $("ad-overlay"),
  purchaseOverlay: $("purchase-overlay"),
  confirmOverlay: $("confirm-overlay"),
  gameOverOverlay: $("game-over-overlay"),
  adTitle: $("ad-title"),
  adCopy: $("ad-copy"),
  adDisclaimer: $("ad-disclaimer"),
...
$("menu-purchase-button").addEventListener("click", () => game.showPurchase());
$("ad-purchase-button").addEventListener("click", () => game.showPurchase());
$("skip-ad-button").addEventListener("click", () => game.skipAdBreak());
$("confirm-purchase-button").addEventListener("click", () => game.completeFakePurchase("Purchase approved by the imaginary cashier."));
$("restore-purchase-button").addEventListener("click", () => game.completeFakePurchase("Pretend purchase restored from a very small cloud."));
$("cancel-purchase-button").addEventListener("click", () => game.closePurchase());
