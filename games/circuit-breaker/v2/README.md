...
Measured with the shipping values (400 games per row):

| play     | moves (median) | p10–p90 | score  | breakers fired |
|----------|----------------|---------|--------|----------------|
| careless | 24.6 (24)      | 21–29   | 5,330  | 0.93 / run     |
| skilled  | 38.8 (37)      | 29–50   | 16,743 | 12.1 / run     |

Playing for cooling roughly **doubles run length and triples score**. `npm test`
asserts these stay in a sane band, so a future retune can't quietly make runs
trivially short or endless.
