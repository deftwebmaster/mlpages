...
import { splashEmpireSceneHtml } from '../components/brand-scenes.js';
 ...
 *
 * Uses the same CSS illustration language as the playable screens so the
 * first impression feels native to the game instead of like a separate poster.
 */
